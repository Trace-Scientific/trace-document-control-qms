...
export const PLATFORM_PERMISSION_DESCRIPTIONS: Record<PlatformPermissionKey, string> = {
  ...
  "platform.notification.read": "Read platform notification inbox and delivery state.",
  "platform.notification.manage": "Create, monitor, and requeue platform notifications.",
  "platform.reporting.read": "Read platform commercial and operational reports.",
