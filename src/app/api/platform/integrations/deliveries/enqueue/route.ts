...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ data: await platformIntegrationService.enqueueOutbound(context, { ...input, payload: input.payload as Prisma.InputJsonObject }) }, { status: 202 });
  } catch (error) {
