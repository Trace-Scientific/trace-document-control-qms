...
export async function GET(request: NextRequest) {
  try {
    ...
    const [organization, sites, departments, users, roles, permissions] = await Promise.all([
    ...
    return NextResponse.json({ data: { organization, sites, departments, users, roles, permissions } });
  } catch (error) {
