...
import { createHelpSupportRequest, HELP_SUPPORT_CATEGORIES, HELP_SUPPORT_PRIORITIES, HelpSupportRequestValidationError, listHelpSupportRequests } from "@/lib/platform/help-support-request";
...
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ data: await listHelpSupportRequests(context) }, { headers: { "Cache-Control": "no-store" } });
  } catch (error) {
